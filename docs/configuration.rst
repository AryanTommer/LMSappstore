...
.. code-block:: python
    ...
    from TechKiteLMSappstore.settings.baseproduction import *
    ...
    DEFAULT_FROM_EMAIL = 'appstore@TechKiteLMS.com'
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'TechKiteLMSappstore',
            'USER': 'TechKiteLMSappstore',
            'PASSWORD': 'password',
            'HOST': '127.0.0.1',
            'PORT': '5432',
        }
    ...
    # https://help.TechKiteLMS.com/categories.json
