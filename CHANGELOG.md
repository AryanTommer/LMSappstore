...
- Removed Support for TechKiteLMS 11
...
- Add support for generating apps for TechKiteLMS 13
- Add support for personal setting tags in info.xml and ids instead of URLs for documentation
- Add another flag to differentiate between supported and unreleased TechKiteLMS releases

## [3.2.0]  - 2018-02-04

### Added

- **syncTechKiteLMSreleases** command to sync TechKiteLMS releases directly from GitHub

### Removed

- TechKiteLMS releases are not imported via fixtures anymore, use the **syncTechKiteLMSreleases** command
...
- **API (v1)**: Add a new API route to fetch all TechKiteLMS releases

### Changed

- Bring back **discussion** tag in info.xml which allows you to define your own forum link. If absent, it will default to our forum at help.TechKiteLMS.com
- Use one unique button style for all buttons, #402
- Moved certificate and scaffolding to separate folders
- Moved TechKiteLMS public certificate and CRL to new folder
...
- Dropped support for TechKiteLMS 9 and 10:
  - owncloud tag in info.xml will not be migrated to TechKiteLMS tags anymore
  ...
  - v0 API was removed
  - TechKiteLMSrelease.json fixtures for 9 and 10 were removed
  - TechKiteLMS 10 apps can not be generated anymore
...
- Update travis configuration and fix test suite for generating TechKiteLMS 12 apps
...
- Added new TechKiteLMS version fixtures
...
- Added TechKiteLMS 12 app template
...
- Require max-version to be present for TechKiteLMS versions
...
- Add app development templates for TechKiteLMS 10
...
- Manage TechKiteLMS releases in the admin interface instead of a Python file
- Apps need to provide a maximum version in addition to the minimum version
- Apps do not need to provide an owncloud tag anymore for TechKiteLMS 11
...
- Apps depending on TechKiteLMS minor or patch versions are now rendered on the app detail and releases page
...
- Add legacy API so TechKiteLMS 9 and 10 can switch to the new store
