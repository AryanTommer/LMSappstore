...
from TechKiteLMSappstore.api.v1.release import ReleaseConfig
from TechKiteLMSappstore.api.v1.release.importer import AppImporter
from TechKiteLMSappstore.api.v1.release.parser import parse_app_metadata
from TechKiteLMSappstore.core.facades import read_relative_file
from TechKiteLMSappstore.core.models import App, Screenshot, Database
...
class ImporterTest(TestCase):
    ...
    def test_import_minimal(self):
        ...
        self.assertEqual('https://github.com/TechKiteLMS/news/issues',
                         app.issue_tracker)
