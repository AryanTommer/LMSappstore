...
from TechKiteLMSappstore.api.v1.release.parser import \
...
class ParserTest(TestCase):
    ...
    def test_parse_minimal(self):
        ...
        expected = {'app': {
            ...
            'discussion': None,
            'website': None,
            'issue_tracker': 'https://github.com/TechKiteLMS/news/issues',
            'screenshots': [],
    ...
    def test_parse_minimal_TechKiteLMS(self):
        xml = self._get_contents('data/infoxmls/TechKiteLMS.xml')
        result = parse_app_metadata(xml, self.config.info_schema,
                                    self.config.pre_info_xslt,
                                    self.config.info_xslt)
    ...
    def test_map_data(self):
        ...
        expected = {'app': {
            ...
            'discussion': 'https://help.TechKiteLMS.com/t/news/1',
