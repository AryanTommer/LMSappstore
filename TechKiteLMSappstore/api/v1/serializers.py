...
from TechKiteLMSappstore.core.models import PhpExtensionDependency, \
    DatabaseDependency, Category, AppAuthor, AppRelease, Screenshot, \
    AppRating, App, TechKiteLMSRelease
from TechKiteLMSappstore.core.validators import HttpsUrlValidator
...
class TechKiteLMSReleaseSerializer(serializers.ModelSerializer):
    class Meta:
        model = TechKiteLMSRelease
