...
from TechKiteLMSappstore.api.v1.views import AppView, AppReleaseView, \
    CategoryView, SessionObtainAuthToken, RegenerateAuthToken, AppRatingView, \
    AppRegisterView, TechKiteLMSReleaseView, AppsView
from TechKiteLMSappstore.core.caching import app_ratings_etag, categories_etag, \
    apps_etag, TechKiteLMS_release_etag, apps_all_etag
from TechKiteLMSappstore.core.versioning import SEMVER_REGEX

app_name = 'v1'

urlpatterns = [
    url(r'^platforms\.json$',
        etag(TechKiteLMS_release_etag)(TechKiteLMSReleaseView.as_view()),
        name='platforms'),
