...
from TechKiteLMSappstore.api.v1.release.importer import AppImporter
from TechKiteLMSappstore.api.v1.release.provider import AppReleaseProvider
from TechKiteLMSappstore.api.v1.serializers import AppSerializer, \
    AppReleaseDownloadSerializer, CategorySerializer, AppRatingSerializer, \
    AppRegisterSerializer, TechKiteLMSReleaseSerializer
from TechKiteLMSappstore.certificate.validator import CertificateValidator
from TechKiteLMSappstore.core.facades import read_file_contents
from TechKiteLMSappstore.core.models import App, AppRelease, Category, \
    AppRating, TechKiteLMSRelease
from TechKiteLMSappstore.core.permissions import UpdateDeletePermission
from TechKiteLMSappstore.core.throttling import PostThrottle
from TechKiteLMSappstore.core.versioning import version_in_spec
from TechKiteLMSappstore.user.facades import update_token
...
class TechKiteLMSReleaseView(ListAPIView):
    queryset = TechKiteLMSRelease.objects.all()
    serializer_class = TechKiteLMSReleaseSerializer
...
class AppView(DestroyAPIView):
    ...
    def _filter_releases(self, data, version):
        ...
        :param version: the TechKiteLMS version that we filter
...
class AppRegisterView(APIView):
    ...
    def post(self, request):
        ...
        chain = read_file_contents(settings.TechKiteLMS_CERTIFICATE_LOCATION)
        crl = read_file_contents(settings.TechKiteLMS_CRL_LOCATION)
