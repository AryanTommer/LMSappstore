...
from TechKiteLMSappstore.core.models import App, Screenshot, TechKiteLMSRelease
from TechKiteLMSappstore.scaffolding.archive import build_archive
from TechKiteLMSappstore.scaffolding.forms import AppScaffoldingForm, \
...
class AppScaffoldingView(FormView):
    ...
    def get_initial(self):
        init = {
            'platform': TechKiteLMSRelease.get_current_main(),
            'categories': ('tools',)
        }
