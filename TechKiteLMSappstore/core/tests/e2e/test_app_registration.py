from TechKiteLMSappstore.core.facades import resolve_file_relative_path, \
    read_relative_file
from TechKiteLMSappstore.core.models import App
from TechKiteLMSappstore.core.tests.e2e import TEST_APP_SIG
from TechKiteLMSappstore.core.tests.e2e.app_dev_steps import AppDevSteps
from TechKiteLMSappstore.core.tests.e2e.base import BaseStoreTest
...
class AppRegistrationTest(BaseStoreTest, AppDevSteps):
    ...
    def test_invalid_cert(self):
        ...
        with self.settings(
            ...
            TechKiteLMS_CERTIFICATE_LOCATION=self.cert_path('ca.crt'),
            TechKiteLMS_CRL_LOCATION=self.cert_path('ca.crl')
        ):
