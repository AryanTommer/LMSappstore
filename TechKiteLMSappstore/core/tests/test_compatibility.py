...
from TechKiteLMSappstore.core.models import App, AppRelease, TechKiteLMSRelease
...
class CompatibilityTest(TestCase):
    ...
    def test_compatible_apps_deduplication(self):
        ...
        AppRelease.objects.create(app=self.app1, version='3.0.0',
                                  platform_version_spec='>=10.0.0,<11.0.0')
        TechKiteLMSRelease.objects.create(version='9.0.0')
        TechKiteLMSRelease.objects.create(version='9.0.1')
        TechKiteLMSRelease.objects.create(version='9.0.2')
        TechKiteLMSRelease.objects.create(version='10.0.0')
    ...
    def test_compatible_releases_by_platform_v(self):
        self._create_example_releases()
        self._create_TechKiteLMS_versions()
    ...
    def _create_TechKiteLMS_versions(self):
        for version in self.platform_versions:
            TechKiteLMSRelease.objects.create(version=version)
