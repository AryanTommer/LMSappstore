...
from TechKiteLMSappstore.core.facades import read_relative_file
from TechKiteLMSappstore.core.github import GitHubClient, \
    get_supported_releases, sync_releases
from TechKiteLMSappstore.core.models import TechKiteLMSRelease
...
class GitHubTest(TestCase):
    ...
    def test_import_releases(self):
        ...
        self.assertEquals(16, TechKiteLMSRelease.objects.count())
    ...
    def get_rel(self, version: str) -> TechKiteLMSRelease:
        return TechKiteLMSRelease.objects.get(version=version)

    def _create_release(self, version: str, is_current: bool,
                        has_release: bool,
                        is_supported: bool) -> TechKiteLMSRelease:
        return TechKiteLMSRelease.objects.create(version=version,
