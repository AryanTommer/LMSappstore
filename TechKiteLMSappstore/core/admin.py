...
from TechKiteLMSappstore.core.models import DatabaseDependency, AppRelease, \
...
@admin.register(TechKiteLMSRelease)
class TechKiteLMSReleaseAdmin(admin.ModelAdmin):
