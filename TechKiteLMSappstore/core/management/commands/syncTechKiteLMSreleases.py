...
from TechKiteLMSappstore.core.github import get_supported_releases, \
    GitHubClient, sync_releases


class Command(BaseCommand):
    help = 'Queries TechKiteLMS\'s GitHub releases API to update all locally ' \
           'stored TechKiteLMS versions'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--oldest-supported', required=True,
                            help='Oldest supported TechKiteLMS version')
