...
from TechKiteLMSappstore.core.models import App, AppReleaseDeleteLog, Category, \
...
def TechKiteLMS_release_etag(request: Any) -> str:
    releases = [Version(rel.version) for rel in TechKiteLMSRelease.objects.all()]
