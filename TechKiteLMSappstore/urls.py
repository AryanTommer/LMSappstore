...
from TechKiteLMSappstore.core.caching import app_rating_etag
from TechKiteLMSappstore.core.feeds import AppReleaseAtomFeed, AppReleaseRssFeed
from TechKiteLMSappstore.core.views import CategoryAppListView, AppDetailView, \
    app_description, AppReleasesView, AppUploadView, AppRatingApi, \
    AppRegisterView
from TechKiteLMSappstore.scaffolding.views import AppScaffoldingView, \
...
urlpatterns = [
    ...
    url(r'^api/', include('TechKiteLMSappstore.api.urls',
                          namespace='api')),
    url(r'^account/',
        include('TechKiteLMSappstore.user.urls', namespace='user')),
