from TechKiteLMSappstore.settings.base import *
...
DEFAULT_FROM_EMAIL = 'TechKiteLMS App Store <appstore@TechKiteLMS.com>'
...
FIXTURE_DIRS = (
    join(BASE_DIR, 'TechKiteLMSappstore/core/tests/e2e/fixtures'),
)
