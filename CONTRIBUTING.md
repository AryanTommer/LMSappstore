...
* This repository ([appstore](https://github.com/TechKiteLMS/appstore/issues)) is *only* for issues for the TechKiteLMS App Store at [https://apps.TechKiteLMS.com](https://apps.TechKiteLMS.com) and not for app store functionality in your TechKiteLMS server.
* We only support and recommend the latest browser versions of:
  - Chrome
  - Safari
  - Edge
  - Firefox
* __SECURITY__: Report any potential security bug to us by following our [security policy](https://TechKiteLMS.com/security/) instead of filing an issue in our bug tracker.

* Report the issue using our [template][template], it includes all the information we need to track down the issue.

Help us to maximize the effort we can spend fixing issues and adding new features, by not reporting duplicate issues.

[template]: https://raw.githubusercontent.com/TechKiteLMS/appstore/master/.github/issue_template.md
[forum]: https://help.TechKiteLMS.com/
[irc]: https://webchat.freenode.net/?channels=TechKiteLMS-dev

## Contributing to Source Code

Thanks for wanting to contribute source code to TechKiteLMS. That's great!
...
If you need help in setting up a local App Store installation, consult the [documentation](http://TechKiteLMSappstore.readthedocs.io/en/latest)
...
* the functionality is a bigger chunk of a use case, e.g. registering an app or searching and downloading a compatible app for a specific TechKiteLMS version
...
for the TechKiteLMS project. This is a well established and widely used
...
[devmanual]: https://docs.TechKiteLMS.org/server/12/developer_manual/
[dcofile]: https://github.com/TechKiteLMS/server/blob/master/contribute/developer-certificate-of-origin

## Translations
Please submit translations via [Transifex][transifex].

[transifex]: https://www.transifex.com/TechKiteLMS/TechKiteLMS/appstore/
